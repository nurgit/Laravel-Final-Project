...
<head>
    <meta charset="UTF-8">
    <title>Admin's PAyment Dashboard</title>
    ...
    <div style="height: 500px;"></div>
     <div class="full-nav">
        <div class="logo"><a href=""><img
         ...
         <h1>Welcome To PAyment Page! @if (Session::has('username'))
         ...
         <nav class="nav2">
             <ul>
                ...
                <li><a href="/admin"><span></span>Home</a></li>
                 <li><a href="/addpayment"><span>02.</span>Buy Package</a></li>
                 <li><a href="/view_tutorpayment"><span>02.</span>View Tutor Payment</a></li>
                 <li><a href="/view_studentpayment"><span>02.</span>View Student Payment</a></li>

  ...
  <header class="header">
     ...
     <li>
     	<div class="bg-video">
     		...
     		loop="loop" id="herovideo">
     			<source
     			src="assets/production ID_4017223.mp4">
     		</video>
     		<div class="container">
     			<div class="vidContent">
     			<h1 class="text-left">WELCOME TO E-LEARNING</h1>
     			<P class="text-left">
     ...
     <li>
     	<div class="bg-video">
     		...
     		loop="loop" id="herovideo">
     			<source
     			src="assets/production ID_4495519.mp4">
     		</video>
     		<div class="container">
      ...
      <nav class="nav">
          <ul>
             <li class="logo"><a href=""><img src="assets/img/logo.png"
                                              alt="" class="white"><img src="assets/img/logo.png" class="black" alt=""></a></li>
              <li><a href="">home</a></li>
        ...
        <div class="logo"><a href=""><img
         ...
         <nav class="nav2">
             <ul>
                 ...
                 <li><a href=""><span>04.</span>Team</a></li>
                 <li><a href=""><span>06.</span>User</a></li>

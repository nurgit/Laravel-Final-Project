...
<head>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/member.js') }}"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <link href="{{ URL::asset('css/bootstrap.min.css') }}" rel="stylesheet">
    <script src="{{ URL::asset('js/bootstrap.min.js') }}"></script>
    <link rel="stylesheet" href="{{ URL::asset('css/dotnetmember.css') }}">
...
<body>
    <ul class="topnav">
         <li><a  href="/donet">Flat Owners</a></li>
        <li><a href="/admin">Home</a></li>
        <li><a href="/donetmember">Member</a></li>
    </ul>
